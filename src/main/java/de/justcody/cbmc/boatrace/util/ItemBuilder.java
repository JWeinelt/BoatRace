...
public class ItemBuilder {
    ...
    private List<Material> canDestroy = new ArrayList<>();
    ...
    /**
     * Initalizes the ItemBuilder with an already existing {@link de.justcody.cbmc.boatrace.util.ItemBuilder}
    ...
    public ItemBuilder canDestroy(Material... destroy) {
        canDestroy.addAll(Arrays.asList(destroy));
        return this;
    }
